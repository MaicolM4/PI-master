...
<body class="hold-transition skin-blue sidebar-mini">
  <div class="wrapper">
                  ...
                  <ul class="menu">
                    <li>
                      ...
                      <a href="#">
                        ...
                        <!-- The message -->
                        <p>¿Por qué no compras un nuevo tema?</p>
                      </a>
                    </li>
                    <!-- end message -->
                  </ul>
    ...
    <!-- Main Footer -->
    <footer class="main-footer" id="copyright">
      <!-- To the right -->
      <!-- Default to the left -->
      <strong>Copyright &copy; 2020 <a href="#">Parqueadero VIDA </a>.</strong> All rights reserved.
    </footer>
