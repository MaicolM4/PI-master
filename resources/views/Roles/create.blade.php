...
<div class="row">
    <div class="col-lg-8 col-md-8 col-sm-8 col-xs-12">
        ...
        <div class="form-group{{ $errors->has('description') ? ' has-error' : '' }}">
            <label for="description" class="col-md-4 control-label">Descripcion Del Rol/Cargo</label>
            <div class="form-group">
        ...
        <div class="form-group">
            ...
            <a class="btn btn-info" type="reset" href="{{url('roles')}}"><span class="glyphicon glyphicon-home"></span> Volver </a>
        </div>
